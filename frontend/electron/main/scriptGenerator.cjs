...
function generateGmatScript({
  ...
  const lines = [
    ...
    "Create ReportFile ValidationReport;", `GMAT ValidationReport.Filename = '${gmatString(reportPath)}';`,
    ...
    "GMAT ValidationReport.WriteReport = true;",
    "GMAT ValidationReport.AppendToExistingFile = false;",
    "GMAT ValidationReport.Precision = 16;",
    ...(includeVisualization ? [
      "Create OpenFramesView ValidationOrbitView_View;",
      "GMAT ValidationOrbitView_View.ViewFrame = CoordinateSystem;",
      "GMAT ValidationOrbitView_View.ViewTrajectory = Off;",
      "GMAT ValidationOrbitView_View.InertialFrame = Off;",
      "GMAT ValidationOrbitView_View.SetDefaultLocation = On;",
      "GMAT ValidationOrbitView_View.DefaultEye = [30000 0 0];",
      "GMAT ValidationOrbitView_View.DefaultCenter = [0 0 0];",
      "GMAT ValidationOrbitView_View.DefaultUp = [0 0 1];",
      "GMAT ValidationOrbitView_View.FOVy = 45;",
      "Create OpenFramesInterface ValidationOrbitView;",
      `GMAT ValidationOrbitView.Add = {${forceModel.centralBody}, ${chaserName}, ${targetName}};`,
      "GMAT ValidationOrbitView.View = {ValidationOrbitView_View};",
      `GMAT ValidationOrbitView.CoordinateSystem = ${frame};`,
      "GMAT ValidationOrbitView.DrawObject = [true true true];",
      "GMAT ValidationOrbitView.DrawTrajectory = [true true true];",
      "GMAT ValidationOrbitView.DrawLabel = [true true true];",
      "GMAT ValidationOrbitView.DrawLineWidth = [2 2 2];",
      "GMAT ValidationOrbitView.DrawMarkerSize = [10 10 10];",
      "GMAT ValidationOrbitView.Axes = On;",
      "GMAT ValidationOrbitView.AxesLabels = On;",
      "GMAT ValidationOrbitView.XYPlane = On;",
      "GMAT ValidationOrbitView.EnableStars = On;",
      "GMAT ValidationOrbitView.ShowPlot = true;",
      "GMAT ValidationOrbitView.ShowToolbar = true;",
      "GMAT ValidationOrbitView.PlaybackTimeScale = 3600;",
    ] : []),
