...
export function createSubmission(submission, inputType) {
  return request("/submissions", {
    method: "POST",
    headers: { "X-Input-Type": inputType },
...
export function getValidationSettings() {
  return request("/settings/validation");
}

export function updateValidationSettings(settings) {
  return request("/settings/validation", {
    method: "PUT",
    headers: { "X-Device-Role": "server" },
